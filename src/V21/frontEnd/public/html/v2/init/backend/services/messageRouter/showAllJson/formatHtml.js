...
export default function formatHtml({ message, fromShowAllJsonAction }) {
    ...
    return `
        ...
        <div class="text-xs space-y-1 mb-4 text-gray-400">
            ...
            <div><b>Create Endpoint:</b> <span class="text-gray-300">${message.createEndPoint || 'Not Selected'}</span></div>
            <div><b>Read Endpoint:</b> <span class="text-gray-300">${message.readEndPoint || 'Not Selected'}</span></div>
            <div><b>Update Endpoint:</b> <span class="text-gray-300">${message.updateEndPoint || 'Not Selected'}</span></div>
            <div><b>Delete Endpoint:</b> <span class="text-gray-300">${message.deleteEndPoint || 'Not Selected'}</span></div>
        </div>
