...
// Get repository details from package.json if possible
let owner = '';
let repo = '';
...
if (!owner || !repo) {
  console.log('Could not automatically determine repository details from package.json.');
  owner = process.env.GITHUB_OWNER || 'keshavsoft';
  repo = process.env.GITHUB_REPO || 'json-crud-ui-init';
}
